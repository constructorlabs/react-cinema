...
class Search extends React.Component {
  ...
  //     this.props.receiver(movieDetails.results);
  ...
  // return fetch(`http://www.omdbapi.com/?i=${eachMovie.Search.imdbID}&plot=full&apikey=39d7228f`);
  //  })
  //   .then(response => response.json())
  //   .then(movieDetails => {
  //     this.props.receiver(movieDetails.results);
  ...
  //     .then(response => response.json())
  //     .then(results => results.Search.map(movie => {
  //       return (fetch(`http://www.omdbapi.com/?i=${movie.imdbID}&plot=full&apikey=39d7228f`)
  //         .then(response => response.json())
  //         .then(movieDetails => {
  //           this.props.receiver(movieDetails.results);
  //         }
