...
class App extends React.Component {
  ...
  searchByTitle(query, pageNum = 1) {
    fetch(`https://www.omdbapi.com/?apikey=507b4100&type=movie&s=${query}&page=${pageNum}`)
  ...
  searchByID(id) {
    fetch(`https://www.omdbapi.com/?apikey=507b4100&type=movie&i=${id}`)
      .then(response => response.json())
      .then(body => {
        this.setState({
          filmDetails: body,
  ...
  searchHint(string, pageNum = 1) {
    fetch(`https://www.omdbapi.com/?apikey=507b4100&type=movie&s=${string}&page=${pageNum}`)
      .then(response => response.json())
      .then(body => {
        this.setState({
          hints: body.Search
