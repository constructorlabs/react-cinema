...
class Movie extends React.Component {
  ...
  componentDidMount() {
    const movieUrl = `http://www.omdbapi.com/?i=${
    ...
    return (
      <article className={articleclasses} id={this.props.movie.imdbID}>
        ...
        >
          ...
          {this.state.clicked ? (
            <Detail movie={this.state.movieresult} />
          ) : null}
        </section>
      </article>
    );
